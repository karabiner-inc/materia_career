...
[![hex.pm](https://img.shields.io/hexpm/l/plug.svg)](https://github.com/karabiner-inc/materia_career/blob/master/LICENSE)
[![Coverage Status](https://coveralls.io/repos/github/karabiner-inc/materia_career/badge.svg?branch=master)](https://coveralls.io/github/karabiner-inc/materia_career?branch=master)
[![Build Status](https://travis-ci.org/karabiner-inc/materia_career.svg?branch=master)](https://travis-ci.org/karabiner-inc/materia_career)
...
```
# Configures Guardian
config :materia_career, materia_career.Authenticator,
...
```
# Configure materia_career repo
config :materia_career, :repo, YourApp.Repo  #<- add your app repo
```
...
do generate migration file for materia_career and migrate

```
> mix materia_career.gen.migration
> mix ecto.create
> mix ecto.migrate
```
...
```
  pipeline :guardian_auth do
    plug materia_career.AuthenticatePipeline #<-- guardian jwt token authentication by user model.
  end
  pipeline :grant_check do
    plug materia_career.Plug.GrantChecker, repo: YourApp.Repo #<-- Grant check by user ,role and grant model.
  end
```

add materia_career user and grant model path.

lib/your_app_web/router.ex

```
  scope "/your-path", materia_careerWeb do
    pipe_through [ :api]
...
materia_career grant is white list about user role and request mothod.

materia_career.Plug.GrantChecker provide simple role check function.
...
※ grant.role "anybody" is a special reserved keyword by materia_career and its means all roles.
※ grant.method "ANY" is a special reserved keyword by materia_career and its means all request methods.
...
to
```
{:materia_career, git: "https://bitbucket.org/karabinertech_bi/materia_career.git"},
```
...
#### Step2 replace Code
 ...
 code replace that
  ...
  - Servicex -> materia_career
  - servicex -> materia_career
  - materia_careerErrorError -> BusinessError
...
```
> mix deps.clean servicex materia_career servicex_utils materia_career_utils
> mix deps.update materia_career materia_career_utils
> mix materia_career.gen.migration

```

If a foreign key construct to the servicex schema was defined,
You need to change the name of materia_career's migration file to be before the name of your migration file.

```
ls -1 priv/repo/migrations
20181006090000_create_your_table
20181206081940_materia_career_1_craete_users.exs
20181206081941_materia_career_2_craete_organizations.exs
20181206081942_materia_career_3_craete_address.exs
20181206081943_materia_career_4_craete_grants.exs
20181206081944_materia_career_5_craete_mail_templates.exs
```
...
```
ls -1 priv/repo/migrations
20180106081940_materia_career_1_craete_users.exs
20180106081941_materia_career_2_craete_organizations.exs
20180106081942_materia_career_3_craete_address.exs
20180106081943_materia_career_4_craete_grants.exs
20180106081944_materia_career_5_craete_mail_templates.exs
20181006090000_create_your_table
```
...
## Servicex -> materia_career change Over View  
 
#### move ServicexMatching.Accounts.User -> materia_career.Accounts.User
...
#### Mix.Tasks.materia_career.Gen.Migration 

  change do'nt execute Mix.Tasks.Guardian.Db.Gen.Migration.run([])
 
#### Servicex.Accounts.Address　-> materia_career.Locations.Address
...
#### materia_career.Authenticator.sign_in()
